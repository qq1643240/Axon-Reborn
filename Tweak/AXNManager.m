...
-(void)saveNotificationForDebug {
    ...
    NSString *debugPath = jbroot(@"/var/mobile/Documents/AxonDebug.txt");
    [[array description] writeToFile:debugPath atomically:false encoding:NSUTF8StringEncoding error:nil];
}
