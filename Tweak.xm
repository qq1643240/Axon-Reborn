...
// 新增：手势清除开关
BOOL swipeClearEnabled;
BOOL swipeClearAllEnabled;
...
-(void)layoutSubviews {
    %orig;
    ((UILabel *)MSHookIvar<id>(self, "_revealHintTitle")).hidden = YES;
}
...
void loadPrefs() {
    ...
    // 新增：读取手势清除设置
    swipeClearEnabled = prefs[@"SwipeClearEnabled"] != nil ? [prefs[@"SwipeClearEnabled"] boolValue] : true;
    swipeClearAllEnabled = prefs[@"SwipeClearAllEnabled"] != nil ? [prefs[@"SwipeClearAllEnabled"] boolValue] : true;
